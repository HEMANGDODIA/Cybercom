...
<div class="container">
    <div class="row">
        <div class="col-12">
        <br>
        <a href="<?php echo $this->getUrl()->getUrl('form','Category'); ?>"  class='btn btn-success pull-right'>Add Category</a>
        <br><br>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <?php if ($values->status == 1):?>
                        ...
                        <td>
                            <div class="buttons">
                                <a href="<?php echo $this->getUrl()->getUrl('form', null, ['categoryId' => $values->categoryId]) ?>" class="btn btn-primary"
                                    >Edit</a>
                                <a href="<?php echo $this->getUrl()->getUrl('delete', null, ['categoryId' => $values->categoryId]) ?>"
