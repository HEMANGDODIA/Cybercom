...
\Mage::loadFileByClassName('Block\Category\Grid');
...
class Category  extends Admin{
    ...
    public function gridAction(){
        ...
        $grid = \Mage::getGrid('Block\Category\Grid');
            // print_r($grid);
            // die();
        $grid->setController($this);
        $grid->setTemplate('View/category/grid.php');
        ...
        public function formAction(){
            ...
            try {
                ...
                $lefttab=\Mage::getEdit('Block\Category\Edit\Tabs');
                $lefttab->setController($this);
                $left->addChild($lefttab);   
    
                $edit = \Mage::getEdit('Block\Category\Edit');
                $edit->setController($this);
                $edit->setTemplate('View/category/form.php');
    ...
    {
        try {
            $cat = \Mage::getModel('Model\Category');
