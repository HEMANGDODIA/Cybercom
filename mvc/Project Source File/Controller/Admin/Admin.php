...
class Admin  extends CoreAdmin {
    ...
    public function setAdmin($admin=null)
    {
        ...
        if(!$admin){
            $admin=\Mage::getAdmin('Model\Admin\Admin');
    ...
    public function gridAction(){
        ...
        echo json_encode($response);
            ...
            // $grid = \Mage::getGrid('Block\Admin\Admin\Grid');
            // $grid->setController($this);
            // $grid->setTemplate('View/admin/admin/grid.php');
...
;
        ...
        public function formAction(){
            ...
            if ($id = (int) $this->getRequest()->getGet('adminId')) {
                $admin = $admin->load($id);
                if (!$admin) {
            ...
            echo json_encode($response);
                ...
                // $lefttab=\Mage::getEdit('Block\Admin\Admin\Edit\Tabs');
                // $lefttab->setController($this);
                // $left->addChild($lefttab);
    
                // $edit = \Mage::getEdit('Block\Admin\Admin\Edit');
                // $edit->setController($this);
                // $edit->setTemplate('View/admin/admin/form.php');
