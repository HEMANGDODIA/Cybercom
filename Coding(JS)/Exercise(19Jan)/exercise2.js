...
function data(n) {
    for (let i = 0; i < n; i++) {
        information.push(new person('Hemang', 18, 'hv@gmail.com', 8128459608))
        information.push(new person('raj', 20, 'rj@gmail.com', 8128459609))
        information.push(new person('ram', 22, 'ram@gmail.com', 8128459607))
        information.push(new person('rahul', 124, 'rahul@gmail.com', 8128459606))
    }
}
data(1)
